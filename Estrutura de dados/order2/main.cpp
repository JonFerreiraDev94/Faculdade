...
mostra(v, n);
	    ...
	    TVetor v;
	      int n, i;
	        ...
	        arquivo = fopen("C:\\Users\\Jon\\Documents\\Documents\\ITE- Sistemas de Informação\\Estrutura de dados\\order2\\bin\\Debug\\ordenar.txt", "rt");
	      if (!arquivo) {
	        cout << endl << "Erro!" << endl;
	      return 1;
	 }
	...
	fclose(arquivo);
	        ...
	        cout << endl << "Abrindo Arquivo...";
	arquivo = fopen("C:\\Users\\Jon\\Documents\\Documents\\ITE- Sistemas de Informação\\Estrutura de dados\\order2\\bin\\Debug\\ordenado.txt", "wt");
	      if (!arquivo) {
	        cout << endl << "Erro!" << endl;
	         return 3;
	 }
